...

{
	...
	public void run(String... args) throws Exception 
	{
		...
		/*
		Direccion direccionAlumno = new Direccion("sann","271","417","5175","117w","npuebla3");
		Persona alumno = new Alumno(null, "matias", "gomez", "1234511891", "1nseg1ura7", direccionAlumno);
